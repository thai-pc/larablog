...
<div class="col-md-4">
    <div class="col-md-12 nopadding">
        <div class="blog1-sidebar-box">
            ...
            <div class="text-box-inner">
                <h5 class="uppercase dosis">Về tôi</h5>
                <p>{{$bio}}</p>
                <br/>
    ...
    <div class="col-md-12 nopadding">
        <div class="blog1-sidebar-box">
            <div class="text-box-inner">
                <h5 class="uppercase dosis">Tìm kỉếm</h5>
                <div class="clearfix"></div>
                <form action="/">
                    <input
    ...
    <div class="col-md-12 nopadding">
        <div class="blog1-sidebar-box">
            <div class="text-box-inner">
                <h5 class="uppercase dosis">Thể loại</h5>
                <div class="clearfix"></div>
    ...
    <div class="col-md-12 nopadding">
        <div class="blog1-sidebar-box">
            <div class="text-box-inner">
                <h5 class="uppercase dosis">Bài viết mới nhất</h5>
                <div class="clearfix"></div>
                @forelse($latestPosts as $single_post)
                    <div class="blog1-sidebar-posts">
                        <div class="image-left">
                            <img src="{{$single_post->feature_image}}"
                                 width="80px"
                                 height="80px"
    ...
    <div class="col-md-12 nopadding">
        <div class="blog1-sidebar-box">
            <div class="text-box-inner">
                <h5 class="uppercase dosis">Từ khóa</h5>
                <div class="clearfix"></div>
                <ul class="tags">
    ...
    <div class="col-md-12 nopadding">
        <div class="blog1-sidebar-box">
            <div class="text-box-inner">
                <h5 class="uppercase dosis">Bản tin</h5>
                <div class="clearfix"></div>
                <input class="blog1-sidebar-serch_input" type="search" placeholder="Nhập địa chỉ email">
