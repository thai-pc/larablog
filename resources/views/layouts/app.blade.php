            ...
            <div class="navbar yellow-green navbar-default yamm">
                ...
                <div id="navbar-collapse-grid" class="navbar-collapse collapse pull-right">
                    <ul class="nav yellow-green navbar-nav">
                        <li><a href="/" class="dropdown-toggle active">Trang chủ</a></li>
                        <li><a href="about.html" class="dropdown-toggle">Về tôi</a></li>
                        ...
                        <li><a href="contact.html" class="dropdown-toggle">Liên hệ tôi</a></li>
                    </ul>
                </div>
            </div>
        </div>
